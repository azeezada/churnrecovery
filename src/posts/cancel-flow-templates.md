...
**Body:**
We'd hate to lose you. If now's not the right time, you can **pause your subscription for 1–3 months** instead of canceling. Your subscription stays active at the end of your pause period, and you won't be charged while you're paused.
...
**Exit survey (shown if they click "Cancel anyway"):**
*What made you decide to cancel today? (optional)*
...
**Headline:**
Your progress doesn't have to stop here.

**Body:**
You've already put real work into [Course/Program Name]. Life gets busy — we get it.
...
**Exit survey (shown after "I want to cancel"):**
...
**Body:**
Canceling a coaching program is a big decision. Before you do, I'd like to understand what's not working.
...
**Exit survey (shown after "Cancel my membership"):**
*What's the biggest reason you're canceling?*
...
**Headline:**
You're about to lose access to [Community Name].

**Body:**
Before you go — here's what you'd be giving up:
...
**Headline:**
Before you cancel — we want to help.

**Body:**
If [Tool Name] isn't working the way you expected, we want to fix it — not just lose you.
