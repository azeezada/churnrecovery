...
→ *ChurnRecovery adds this cancel flow to any membership site that uses Stripe — [see how it works](/demo)*
...
If your membership platform doesn't have a pause feature, [ChurnRecovery](/for/kajabi) can add it at the Stripe level — regardless of what platform you're on.
...
[Try the live demo →](/demo) · [Calculate your churn rate →](/tools/churn-rate-calculator)

ChurnRecovery works with any membership platform that uses Stripe — including [Kajabi](/for/kajabi), [Teachable](/for/teachable), [Ghost](/for/ghost), [Memberful](/for/memberful), WordPress/WooCommerce, and more.
