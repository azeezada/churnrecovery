...
1. Shows a cancel flow (a customizable popup) when a user tries to leave
2. Sends automated emails when a payment fails
3. Gives you a dashboard to track cancellations and recovered revenue
