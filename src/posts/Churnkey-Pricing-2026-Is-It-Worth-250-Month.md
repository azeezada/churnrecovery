...
| Multiple processors | ✅ Stripe, Recurly, etc | ✅ Stripe, others | ❌ Stripe only |
| Custom branding | ✅ Paid plans | ✅ Always free | ❌ Limited |
| A/B testing | ✅ Limited on starter | ✅ Full access | ❌ None |
| API access | 🔶 Limited | ✅ Full API | 🔶 Basic |
| Open source | ❌ Closed | ✅ MIT license | ❌ Closed |
| Free tier | ❌ None | ✅ Unlimited | ❌ None |
