...
2. They find the subscription management page
3. They click "Cancel"
...
1. **Asks why** — a quick multiple-choice question (price, not using it, found something better, etc.)
2. **Makes an offer based on the reason** — pause instead of cancel, a discount, a skip, or just a personal note
3. **Lets them confirm or change their mind**
...
1. Connect your Stripe account to ChurnRecovery (takes about 2 minutes)
2. Build your cancel flow — choose your questions, write your offers, set your rules
3. The flow goes live automatically for any Stripe-powered cancellation
...
**Step 2:** Connect ChurnRecovery to your Stripe account — [start here for Stripe users →](/for/stripe)
...
**Ready to stop losing subscription revenue on Shopify?** [Book a free demo →](/demo) and we'll walk you through exactly what a cancel flow looks like for your specific store — including what offers tend to work best in your product category.

Also worth reading: [How ChurnRecovery works with Stripe →](/for/stripe) and [see cancel flow templates →](/posts/cancel-flow-templates)
