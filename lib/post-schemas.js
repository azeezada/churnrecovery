...
export const postSchemas = {
  ...
  'dunning-management-guide-small-business': [
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What is dunning management?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: "Dunning management is the process of recovering failed recurring payments through automated retries, email notifications, and grace periods. The term comes from 17th-century British slang for chasing unpaid debts. In modern subscription businesses, a smart dunning system looks at the payment failure code and responds with intelligent retry timing and personalized emails — recovering 70–85% of failed payments vs. 15–25% with no system.",
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: "A proven sequence uses 4 touchpoints over 21 days: Day 0 (friendly notice with billing update link), Day 3 (first retry + gentle reminder), Day 7 (second retry + urgency with a specific deadline), and Day 14 (final notice before cancellation on Day 21). Each email should include a direct link to update billing info. This sequence recovers most passive churn without annoying subscribers.",
          },
        },
        {
          '@type': 'Question',
          name: 'What is a good failed payment recovery rate?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: "With no dunning system, Stripe's basic automatic retry recovers 15–25% of failed payments. Basic dunning (retry + 2–3 emails) achieves 50–65% recovery. Smart dunning with intelligent retry timing and personalized email sequences reaches 70–85%. For a business with $20k MRR, moving from 25% to 70% recovery can mean $4,500–$6,000 in additional monthly revenue.",
          },
        },
        {
          '@type': 'Question',
          name: 'Does Stripe have built-in dunning?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: "Stripe has basic dunning through its Smart Retries feature (Adaptive Acceptance), which uses machine learning to time payment retries. You can enable it in Settings → Subscriptions → Manage failed payments. Stripe can also send automatic emails at each retry point. This gets you to 'basic dunning' tier. For more advanced personalized email sequences and granular retry control, you'll need a dedicated dunning tool.",
          },
        },
        {
          '@type': 'Question',
          name: 'What is the difference between dunning and a cancel flow?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: "Dunning addresses passive churn (involuntary) — subscribers whose payments failed for technical reasons like expired cards or insufficient funds. A cancel flow addresses active churn (voluntary) — subscribers who deliberately chose to cancel. They require completely different solutions. Dunning uses retry logic and payment update emails. Cancel flows intercept the cancellation moment with pause offers, discounts, and exit surveys. The combination of both is the full stack of subscription retention.",
          },
        },
      ],
    },
