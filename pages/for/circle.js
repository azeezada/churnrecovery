  ...
  return (
    <div className="bg-white border border-[#E5E5E5] rounded-xl py-7 px-6">
      <div className="flex gap-4 items-start mb-4">
        <div className="w-12 h-12 rounded-full bg-[#FFF7ED] border-2 border-[#F97316] flex items-center justify-center font-sans font-extrabold text-[1.1rem] text-[#F97316] shrink-0">{number}</div>
        <div>
      ...
      {callout && (
        <div className="bg-[#FFF7ED] border border-[#F9731630] rounded-lg py-2.5 px-3.5 font-sans text-[0.8rem] text-[#F97316]">
          {callout}
        </div>
      )}
    </div>
    ...
    <>
      ...
      <main className="font-sans bg-[#FAF9F5] pt-[60px]">
        ...
        <section className="bg-[linear-gradient(135deg,#1C0A00_0%,#2E1500_50%,#1C0A00_100%)] pt-20 px-6 pb-[100px] relative overflow-hidden">
          ...
          <div className="max-w-[720px] mx-auto text-center relative z-[1]">
            ...
            <div className="max-w-[480px] mx-auto mb-6">
              <SignUpCTA source="for-circle" dark={true} />
            </div>
        ...
        <section className="py-20 px-6 bg-[#FAF9F5]">
          <div className="max-w-[1080px] mx-auto">
            <div className="text-center mb-12">
              <div className="font-sans text-xs font-bold text-[#EA580C] uppercase tracking-[0.08em] mb-3">The Community Builder Problem</div>
        ...
        <section id="how-it-works" className="py-20 px-6 bg-white">
          <div className="max-w-[1080px] mx-auto">
            <div className="text-center mb-12">
              <div className="font-sans text-xs font-bold text-[#F97316] uppercase tracking-[0.08em] mb-3">How It Works</div>
              <h2 className="font-sans font-extrabold text-[clamp(1.8rem,4vw,2.5rem)] text-[#191919] mb-4 tracking-[-0.02em]">
            ...
            <div className="mt-8 bg-[#FFF7ED] border border-[#F9731630] border-l-[4px] border-l-[#F97316] rounded-[10px] py-5 px-6 max-w-[680px] mx-auto">
              ...
              <Link href="/docs" className="font-sans text-[0.82rem] text-[#F97316] no-underline font-semibold">
                Read the technical docs →
              </Link>
            </div>

            <div className="text-center mt-10">
              <Link href="/demo" className="inline-flex items-center gap-2 bg-[#FFF7ED] border border-[#F9731640] rounded-[10px] py-3.5 px-7 font-sans font-bold text-[#F97316] no-underline text-[0.95rem]">
        ...
        <section className="py-20 px-6 bg-[#FAF9F5]">
          <div className="max-w-[1080px] mx-auto">
            <div className="text-center mb-12">
              <div className="font-sans text-xs font-bold text-[#F97316] uppercase tracking-[0.08em] mb-3">What You Get</div>
